...
<p>Find the node in the BST that the node's value equals <code></code><l-core class="L-underline"> and return the subtree rooted with that node</l-core>. If such a node does not exist, return <code>null</code>.</p>
