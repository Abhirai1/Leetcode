...
<ul>
	<li>The "linked list" should use the same <code>TreeNode</code> class where the <code></code><l-core class="L-underline"> child pointer points to the next node in the list and t</l-core>he <code>left</code> child pointer is always <code>null</code>.</li>
